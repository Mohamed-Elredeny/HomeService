...
<center>
    <!-- Change City -->
    <form action="FacilityServicesServices.php" method="post">
...
<center>
    ...
    <a href="AdministrativeservicesRef.php"><input type="button" class="btn btn-primary" value="الخدمات"></a>
    <a href="FacilityServices.php"><input type="button" class="btn btn-danger" value="خدمات المرافق"></a>

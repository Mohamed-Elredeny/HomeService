...
<?php  if(@count(@$MaintainRequests) > 0){ ?>
    <?php foreach ($MaintainRequests as $m){ ?>
        <?php if( SelectWithThree('agricultureServices','usersRequestIds',$m['userId'],$m['requestId']) == '1' ){ ?>
            <div class="card-body" style="height: 300px;width: auto;display: inline-block;margin-left: 10px;margin-top: 20px;text-align: center;padding-top: 20px;padding-bottom: 70px">
                <form action="agriculturalServicesAcc.php" method="post">
